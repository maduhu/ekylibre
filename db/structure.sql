...
--
-- Name: timesheet_items; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE timesheet_items (
    id integer NOT NULL,
    timesheet_id integer NOT NULL,
    project_items_id integer,
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    creator_id integer,
    updater_id integer,
...
--
-- Name: timesheet_items_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE timesheet_items_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: timesheet_items_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE timesheet_items_id_seq OWNED BY timesheet_items.id;
...
--
-- Name: work_contract_natures; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE work_contract_natures (
    id integer NOT NULL,
    name character varying,
    description character varying,
    created_at timestamp without time zone NOT NULL,
...
--
-- Name: work_contract_natures_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE work_contract_natures_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: work_contract_natures_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE work_contract_natures_id_seq OWNED BY work_contract_natures.id;
...
CREATE TABLE work_contracts (
    id integer NOT NULL,
    work_contract_nature_id integer NOT NULL,
...
CREATE SEQUENCE work_contracts_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE work_contracts_id_seq OWNED BY work_contracts.id;
...
ALTER TABLE ONLY timesheet_items ALTER COLUMN id SET DEFAULT nextval('timesheet_items_id_seq'::regclass);
...
ALTER TABLE ONLY work_contract_natures ALTER COLUMN id SET DEFAULT nextval('work_contract_natures_id_seq'::regclass);
...
ALTER TABLE ONLY work_contracts ALTER COLUMN id SET DEFAULT nextval('work_contracts_id_seq'::regclass);
...
--
-- Name: project_items_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: timesheet_items_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY timesheet_items
    ADD CONSTRAINT timesheet_items_pkey PRIMARY KEY (id);
...
--
-- Name: work_contract_natures_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY work_contract_natures
    ADD CONSTRAINT work_contract_natures_pkey PRIMARY KEY (id);


--
-- Name: work_contracts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY work_contracts
...
--
-- Name: index_intervention_participations_on_timesheet_item_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_intervention_participations_on_timesheet_item_id ON intervention_participations USING btree (timesheet_item_id);
...
--
-- Name: index_project_items_on_created_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_project_items_on_created_at ON project_items USING btree (created_at);


--
-- Name: index_project_items_on_creator_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_project_items_on_creator_id ON project_items USING btree (creator_id);


--
-- Name: index_project_items_on_project_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: index_project_items_on_updated_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_project_items_on_updated_at ON project_items USING btree (updated_at);


--
-- Name: index_project_items_on_updater_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_project_items_on_updater_id ON project_items USING btree (updater_id);


--
-- Name: index_project_items_on_variant_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_project_items_on_variant_id ON project_items USING btree (variant_id);
...
CREATE INDEX index_projects_on_activity_id ON projects USING btree (activity_id);
...
--
-- Name: index_purchases_on_project_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_purchases_on_project_id ON purchases USING btree (project_id);
...
--
-- Name: index_sales_on_project_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_sales_on_project_id ON sales USING btree (project_id);
...
--
-- Name: index_timesheet_items_on_created_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_timesheet_items_on_created_at ON timesheet_items USING btree (created_at);


--
-- Name: index_timesheet_items_on_creator_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_timesheet_items_on_creator_id ON timesheet_items USING btree (creator_id);


--
-- Name: index_timesheet_items_on_project_items_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_timesheet_items_on_project_items_id ON timesheet_items USING btree (project_items_id);


--
-- Name: index_timesheet_items_on_timesheet_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_timesheet_items_on_timesheet_id ON timesheet_items USING btree (timesheet_id);


--
-- Name: index_timesheet_items_on_updated_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_timesheet_items_on_updated_at ON timesheet_items USING btree (updated_at);


--
-- Name: index_timesheet_items_on_updater_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_timesheet_items_on_updater_id ON timesheet_items USING btree (updater_id);


--
-- Name: index_timesheets_on_created_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_timesheets_on_created_at ON timesheets USING btree (created_at);


--
-- Name: index_timesheets_on_creator_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_timesheets_on_creator_id ON timesheets USING btree (creator_id);


--
-- Name: index_timesheets_on_payslip_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_timesheets_on_payslip_id ON timesheets USING btree (payslip_id);


--
-- Name: index_timesheets_on_updated_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_timesheets_on_updated_at ON timesheets USING btree (updated_at);


--
-- Name: index_timesheets_on_updater_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_timesheets_on_updater_id ON timesheets USING btree (updater_id);


--
-- Name: index_timesheets_on_work_contract_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_timesheets_on_work_contract_id ON timesheets USING btree (work_contract_id);
...
--
-- Name: index_work_contract_natures_on_created_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_work_contract_natures_on_created_at ON work_contract_natures USING btree (created_at);


--
-- Name: index_work_contract_natures_on_creator_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_work_contract_natures_on_creator_id ON work_contract_natures USING btree (creator_id);


--
-- Name: index_work_contract_natures_on_updated_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_work_contract_natures_on_updated_at ON work_contract_natures USING btree (updated_at);


--
-- Name: index_work_contract_natures_on_updater_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_work_contract_natures_on_updater_id ON work_contract_natures USING btree (updater_id);


--
-- Name: index_work_contracts_on_created_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_work_contracts_on_created_at ON work_contracts USING btree (created_at);


--
-- Name: index_work_contracts_on_creator_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_work_contracts_on_creator_id ON work_contracts USING btree (creator_id);


--
-- Name: index_work_contracts_on_employee_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_work_contracts_on_employee_id ON work_contracts USING btree (employee_id);


--
-- Name: index_work_contracts_on_updated_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_work_contracts_on_updated_at ON work_contracts USING btree (updated_at);


--
-- Name: index_work_contracts_on_updater_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_work_contracts_on_updater_id ON work_contracts USING btree (updater_id);


--
-- Name: index_work_contracts_on_work_contract_nature_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_work_contracts_on_work_contract_nature_id ON work_contracts USING btree (work_contract_nature_id);
...
INSERT INTO schema_migrations (version) VALUES ('20170913211901');
